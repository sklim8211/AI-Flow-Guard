    ...
    return (
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex-1 overflow-y-auto px-4 py-3 space-y-5">
          {/* Always-visible daily habit hint */}
          <div
            style={{
              background: "#eef2ff",
          ...
          >
            <p className="font-bold text-slate-800 mb-1">Daily habit</p>
            <p>Save once at the end of each day.</p>
            <p>Resume + Summary is enough for most days.</p>
            <p>Next day: Merge saved files → paste into a new chat → pick up instantly.</p>
          </div>
